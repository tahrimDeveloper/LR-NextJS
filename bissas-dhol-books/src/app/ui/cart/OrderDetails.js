...
const OrderDetails = () => {
  ...
  return (
    <div className="w-full max-w-xs bg-gray-300  text-black shadow-md rounded px-8 pt-6 pb-8 mb-4 lg:ml-4 xl:ml-4 2xl:ml-4 lg:mr-4 xl:mr-4 2xl:mr-4">
        ...
        <>
          <ul className="pb-4 text-md">
            <li>
              ...
              <strong>{priceForBuy} BDT </strong>
            </li>
            <li>
              Renting {bookToRent.length} book(s) for{' '}
              <strong>{priceForRent} BDT</strong>
            </li>
            <li className="pt-2">
              Delivery Charge: <strong>{deliveryCharge} BDT</strong>
            </li>
          </ul>
          ...
          <div className="pt-4">
            ...
            <p className="text-center p-4 text-5xl font-semibold">
              {priceForBuy + priceForRent + deliveryCharge} BDT
            </p>
          </div>
        </>
      ) : (
